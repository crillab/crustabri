...
where
    T: LabelType,
{
    encoder: DynamicStableConstraintsEncoder<T>,
    ...
    T: LabelType,
{
        ...
        T: LabelType,
    {
        ...
        Self {
            encoder: DynamicStableConstraintsEncoder::new(Rc::clone(&solver)),
            solver,
        }
    }
}
...
pub struct DynamicStableConstraintsEncoder<T>
where
    T: LabelType,
{
    af: AAFramework<T>,
...
impl<T> DynamicStableConstraintsEncoder<T>
where
    T: LabelType,
{
    fn new(solver: Rc<RefCell<Box<dyn SatSolver>>>) -> Self
    where
        T: LabelType,
    {
        Self {
    ...
    fn assumptions(&self) -> &[Literal] {
        &self.assumptions
    }

    fn arg_to_lit(&self, arg: &T) -> Literal {
